<?php
	...
	if( empty($Age) ) echo "age field is empty</br>";
     ...
     if( $StudentNameOK==1 && $ClassOK==1 && $IdOK==1 && $AgeOK==1 ){
        ...
        else echo "<b>THANX FOR REGISTRATION</b></br>";
        $sql_cmnd = 
        " INSERT INTO tblcr VALUES ('$StudentName','$Class','$Id','$Age') ";
        if($conn->query($sql_cmnd) === TRUE) echo "<b>Your registration is completed</b></br>" ;
